...
export const HeroMainboardStuff: React.FC<{ className: string }> = ({
  className,
}) => (
  <svg
    className={cn("pointer-events-none hidden sm:flex", className)}
    width="1368"
    height="476"
...
export const HeroMainboardStuffMobile: React.FC<{ className: string }> = ({
  className,
}) => (
  <svg
    className={cn("pointer-events-none flex sm:hidden", className)}
    width="1368"
    height="476"
    viewBox="0 0 668 476"
    fill="none"
