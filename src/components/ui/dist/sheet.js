...
var SheetOverlay = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(SheetPrimitive.Overlay, __assign({ className: utils_1.cn("fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className) }, props, { ref: ref })));
});
...
var SheetContent = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(SheetPortal, null,
        ...
        React.createElement(SheetPrimitive.Content, __assign({ ref: ref, className: utils_1.cn(sheetVariants({ side: side }), className) }, props),
...
var SheetTitle = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(SheetPrimitive.Title, __assign({ ref: ref, className: utils_1.cn("text-lg font-semibold text-foreground", className) }, props)));
});
exports.SheetTitle = SheetTitle;
SheetTitle.displayName = SheetPrimitive.Title.displayName;
var SheetDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(SheetPrimitive.Description, __assign({ ref: ref, className: utils_1.cn("text-sm text-muted-foreground", className) }, props)));
});
