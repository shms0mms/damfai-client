...
var useFormField = function useFormField() {
  ...
  var _a = react_hook_form_1.useFormContext(),
...
var FormItem = React.forwardRef(function (_a, ref) {
  ...
  return React.createElement(FormItemContext.Provider, {
    ...
    ref: ref,
    className: utils_1.cn("space-y-2", className)
  }, props)));
});
...
var FormLabel = React.forwardRef(function (_a, ref) {
  ...
  return React.createElement(label_1.Label, __assign({
    ref: ref,
    className: utils_1.cn("font-semibold", className),
    htmlFor: formItemId
  }, props));
});
...
var FormDescription = React.forwardRef(function (_a, ref) {
  ...
  return React.createElement("p", __assign({
    ...
    className: utils_1.cn("text-[0.8rem] text-muted-foreground", className)
  }, props));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
  ...
  return React.createElement("p", __assign({
    ref: ref,
    id: formMessageId,
    className: utils_1.cn("text-[0.8rem] font-medium text-destructive", className)
  }, props), body);
});
