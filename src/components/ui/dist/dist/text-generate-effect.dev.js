...
exports.TextGenerateEffect = function (_a) {
  ...
  var _d = framer_motion_1.useAnimate(),
      scope = _d[0],
      animate = _d[1];
  ...
  var renderWords = function renderWords() {
    return React.createElement(framer_motion_1.motion.div, {
      ...
      return React.createElement(framer_motion_1.motion.span, {
        key: word + idx,
  ...
  return React.createElement("div", {
    className: utils_1.cn("text-2xl font-bold", className)
  }, React.createElement("div", {
    className: "mt-4"
  }, React.createElement("div", {
    className: "leading-snug tracking-wide text-foreground"
  }, renderWords())));
};