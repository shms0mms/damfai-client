...
export const PinContainer = ({
  ...
  const onMouseEnter = () => {
    setTransform("translateY(-20%) rotateX(30deg) scale(0.8)")
  }
  const onMouseLeave = () => {
  ...
  return (
    <div
      className={cn(
        "relative z-50 block h-full w-full cursor-pointer",
        containerClassName
      )}
    ...
    >
      ...
      >
        <div
          ...
          className="border-white/[0.1 flex h-full items-start justify-start overflow-hidden rounded-2xl border transition duration-700 group-hover/pin:border-white/[0.2]"
        >
